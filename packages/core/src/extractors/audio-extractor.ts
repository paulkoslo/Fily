...
export class AudioExtractor implements Extractor {
  ...
  async extract(filePath: string, extension: string): Promise<ExtractionResult> {
    ...
    try {
      ...
      // Transcribe using Whisper (counts as 1 worker) with timeout protection
      ...
      const extractedContent: ExtractedContent = {
        ...
        extractedText: text, // Transcription (truncated to 1000 words)
